...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">Create Data Director</h1>
    <p class="mb-4">Halaman ini merupakan halaman untuk Create. atau tambah data dari director</p>

    <!-- Basic Card Example -->
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Tambah Data Director</h6>
        </div>
        <div class="card-body">
