...
<div class="container-fluid">
    ...
    <p class="mb-4">Halaman ini merupakan halaman untuk Update. atau edit data director</p>

    <!-- Basic Card Example -->
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Edit Data Director</h6>
        </div>
        <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control" id="country" name="country" type="text" value="<?= $data_director['country'] ?>" placeholder="" data-sb-validations="required" />
                        </div>
                        <div class="mb-3">
