        ...
        <div class="card-body">
            ...
            <form id="contactForm" data-sb-form-api-token="API_TOKEN" action="" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input class="form-control" id="duration" name="duration" type="number" placeholder="Duration" data-sb-validations="required" />
                ...
                <div class="mb-3">
                    ...
                    <input class="form-control" id="production" name="production" type="text" placeholder="Production" data-sb-validations="required" />
                    <div class="invalid-feedback" data-sb-feedback="production:required">Production is required.</div>
                </div>
                <div class="mb-3">
                    <label class="form-label" for="video">Video</label>
                    <input class="form-control" id="video" name="video" type="text" placeholder="Video" data-sb-validations="required" />
