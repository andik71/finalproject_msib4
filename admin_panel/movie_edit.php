                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control" id="production" name="production" type="text" placeholder="Production" data-sb-validations="required" value="<?= $data_movie['production'] ?>" />
                            <div class="invalid-feedback" data-sb-feedback="production:required">Production is required.</div>
                        </div>
                        <div class="mb-3">
                            <label class="form-label" for="country">Country</label>
                            <input class="form-control" id="country" name="country" type="text" placeholder="Country" data-sb-validations="required" value="<?= $data_movie['country'] ?>" />
