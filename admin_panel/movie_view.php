...
// SQL
$data_movie = select("SELECT m.id_movie, m.title, m.synopsis, m.img, m.release_date, m.duration, m.production, m.video, m.country, g.genre, t.tags, d.name as director_name, a.name as actor_name
                      FROM movie AS m
...
// Memastikan hanya mengambil satu baris data
$data_movie = !empty($data_movie) ? $data_movie[0] : null;
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control" id="duration" name="duration" type="text" placeholder="" value="<?= $data_movie['duration'] ?>" disabled readonly />
                    </div>
                </div>
                <!-- Right Grid -->
                <div class="col-lg-4 col-md-6">
