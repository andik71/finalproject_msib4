        ...
        <div class="footer-body container">
            <div class="row">
                <div class="col-sm-6 col-lg-3 pt-4">
                 <h3 class="font-weight-bold">Film Kita</h3>
                </div>
                ...
                <div class="col-sm-6 col-lg-3">
                    ...
                    <div class="col-4">
                        <ul class="list-unstyled list-wide footer-content">
                            ...
                            <li>
                                <a class="content-link" href="#">Fantasy</a>
                            </li>
                            <li>
                                <a class="content-link" href="#">Horror</a>
                            </li>
                        </ul>
                    </div>
                    <div class="col-4">
                        <ul class="list-unstyled list-wide footer-content">
                            <li>
                                <a class="content-link" href="#">Biography</a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a class="content-link" href="#">Drama</a>
                            </li>
                            <li>
                                <a class="content-link" href="#">Romance</a>
                            </li>
                            <li>
                                <a class="content-link" href="#">Comedy</a>
                            </li>
                        </ul>
                    </div>
                    </div>
